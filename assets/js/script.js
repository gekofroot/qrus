...
panelToggle.addEventListener('click', () => {
  if (panelToggleValue === 0) {
    ...
    toggleDivs[2].style.transform = 'rotate(360deg) translateY(-1.1em)'
    ...
    // build selected modules into query assembly
    for (let x = 0; x < flagToggles.length; x++) {
      if (flagToggles[x] === 1) {
