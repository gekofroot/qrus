...
let babTxt = document.getElementById('bab-txt')
...
let h2Title = document.getElementById('h2-title')
let thinejardinLink = document.getElementById('thinejardin-link')
...
bab.addEventListener("click", () => {
  if (babToggle === 0) {
    bab.style.width = "75%"
    babTxt.style.display = "flex"
    babTxt.style.opacity = "100"
    babTxt.innerText = "Buy me a sandwhich"
    babToggle = 1
  } else if (babToggle === 1) {
    babTxt.innerText = "qrusaur@gmail.com"
    babToggle = 2
  } else if (babToggle === 2) {
    bab.style.width = "4em"
    babTxt.style.display = "none"
    babTxt.style.opacity = "0"
    babTxt.setAttribute("value", "")
    babToggle = 0
  }
})

h2Title.addEventListener('dblclick', ()=> {
  thinejardinLink.click()
})
